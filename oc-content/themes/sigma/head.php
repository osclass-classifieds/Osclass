...
<?php if(osc_get_prev_url() != '') { ?><link rel="prev" href="<?php echo osc_get_prev_url(); ?>" /><?php } ?>
<?php if(osc_get_next_url() != '') { ?><link rel="next" href="<?php echo osc_get_next_url(); ?>" /><?php } ?>
...
// Load google fonts preloaders
osc_add_hook('header', function() {
  echo '<link rel="preconnect" href="https://fonts.googleapis.com">';
  echo '<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>';
}, 7);

osc_enqueue_style('font-sigma', 'https://fonts.googleapis.com/css2?family=Merriweather:wght@400;700&family=Nunito:wght@400;700&display=swap');
