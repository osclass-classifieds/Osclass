...
function addHelp() {
  echo '<p>' . sprintf(__('Manually add Osclass themes in .zip format. If you prefer, you can manually upload the decompressed theme to <em>%s/themes</em>.'), OC_CONTENT_FOLDER) . '</p>';
}
