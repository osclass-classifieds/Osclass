...
function customHead(){
  ...
  $(document).ready(function(){
    ...
    $("#b_remove_country").on("click", function() {
      ...
      $("#dialog-location-delete input[name='action']").attr('value', 'delete_country');
    ...
    $("#b_remove_region").on("click", function() {
      ...
      $("#dialog-location-delete input[name='action']").attr('value', 'delete_region');
    ...
    $("#b_remove_city").on("click", function() {
      ...
      $("#dialog-location-delete input[name='action']").attr('value', 'delete_city');
      $("#dialog-location-delete").dialog('open');
      return false;
    });
  ...
  var s_close = '<?php echo osc_esc_js(__('Remove')); ?>';
  var s_view_more = '<?php echo osc_esc_js(__('Expand')); ?>';
  ...
  function delete_dialog(item_id, item_type) {
    $("#dialog-location-delete input[name='action']").attr('value', item_type);
...
<div class="grid-system">
  ...
  <form id="dialog-location-import" method="get" action="<?php echo osc_admin_base_url(true); ?>" class="has-form-actions hide">
    <input type="hidden" name="page" value="locations" />
    <input type="hidden" name="action" value="locations_import" />
    <div class="form-horizontal">
      <div class="form-row">
