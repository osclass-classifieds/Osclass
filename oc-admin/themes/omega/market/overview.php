<?php
  ...
  $p = osc_file_get_contents_json('https://osclasspoint.com/oc-content/plugins/market/api/v3/products.php?productId=' . $id . '&apiKey=' . osc_get_preference('osclasspoint_api_key', 'osclass'));
?>
