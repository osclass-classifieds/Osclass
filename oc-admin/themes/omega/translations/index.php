...
function addHelp() {
  echo '<p>' . __('Edit translation catalogs for the core, backoffice, themes, and plugins. Open a language and section to translate strings or merge catalogs.') . '</p>';
}
            ...
            <div class="row">
              <?php if(is_array(__get('core_translations')) && count(__get('core_translations')) > 0) { ?>
                <?php foreach(__get('core_translations') as $t) { ?>
                  ...
                  <div class="elem">
                    <div class="img" style="background:#<?php echo substr(md5((string)$t['language']), 0, 6); ?>;">
                      <div class="top"><?php echo strtoupper((string)$parts[0]); ?></div>
                      <div class="bottom"><?php echo strtoupper((string)$parts[1]); ?></div>
                    </div>
                      ...
                      <div class="files">
                        <?php if(is_array($t['files']) && count($t['files']) > 0) { ?>
                          <?php foreach($t['files'] as $f) { ?>
                            <a href="<?php echo osc_admin_base_url(); ?>?page=translations&action=edit&language=<?php echo $t['language']; ?>&type=CORE&section=<?php echo strtoupper(str_replace('.po', '', basename((string)$f))); ?>&theme=&plugin="><?php echo ucwords(str_replace('.po', '', basename((string)$f))); ?></a>
                          <?php } ?>
                        <?php } ?>
                      </div>
                      <div class="stats">
                  ...
                  <div class="elem">
                    ...
                    <div class="data">
                      ...
                      <div class="files">
                        <?php if(is_array($t['files']) && count($t['files']) > 0) { ?>
                          <?php foreach($t['files'] as $f) { ?>
                            <a href="<?php echo osc_admin_base_url(); ?>?page=translations&action=edit&language=<?php echo $t['language']; ?>&type=ADMIN&section=&theme=&plugin="><?php echo ucwords(str_replace('.po', '', basename((string)$f))); ?></a>
                          <?php } ?>
                        <?php } ?>
                      </div>
                      <div class="stats">
              ...
              <?php if(is_array(__get('themes_translations')) && count(__get('themes_translations')) > 0) { ?>
                <?php foreach(__get('themes_translations') as $t) { ?>
                  ...
                  <div class="elem">
                    ...
                    <div class="data">
                      <div class="name"><?php echo ucwords(str_replace('_', ' ', (string)$t['subject'])) . ' / ' . $t['language_name']; ?></div>
                      <div class="files">
                        <?php if(is_array($t['files']) && count($t['files']) > 0) { ?>
                          <?php foreach($t['files'] as $f) { ?>
                            <a href="<?php echo osc_admin_base_url(); ?>?page=translations&action=edit&language=<?php echo $t['language']; ?>&type=THEME&section=&theme=<?php echo $t['subject']; ?>&plugin="><?php echo ucwords(str_replace('.po', '', basename((string)$f))); ?></a>
                          <?php } ?>
                        <?php } ?>
                      </div>
                      <div class="stats">
                  ...
                  <div class="elem">
                    ...
                    <div class="data">
                      ...
                      <div class="files">
                        <?php if(is_array($t['files']) && count($t['files']) > 0) { ?>
                          <?php foreach($t['files'] as $f) { ?>
                            <a href="<?php echo osc_admin_base_url(); ?>?page=translations&action=edit&language=<?php echo $t['language']; ?>&type=PLUGIN&section=&theme=&plugin=<?php echo $t['subject']; ?>"><?php echo ucwords(str_replace('.po', '', basename((string)$f))); ?></a>
                          <?php } ?>
                        <?php } ?>
                      </div>
                      <div class="stats">
