  ...
  function doModel() {
    switch($this->action) {
      ...
      case('update'):
        ...
        $bBlockIndexingEnabled = Params::getParam('block_indexing_enabled');
        ...
        $bBlockIndexingEnabled = ($bBlockIndexingEnabled != '' ? true : false);
        ...
        $iUpdated += osc_set_preference('block_indexing_enabled', $bBlockIndexingEnabled);
