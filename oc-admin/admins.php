  ...
  function doModel() {
    ...
    switch($this->action) {
      case('add'):    // callin add view
        $this->_exportVariableToView( 'admin', array());
      ...
      case('add_post'):
        ...
        $sModeratorAccess = Params::getParam('s_moderator_access');
        ...
        $sModeratorAccess = strip_tags($sModeratorAccess);
        $sModeratorAccess = trim(preg_replace('~[\r\n]+~', ',', $sModeratorAccess));
        $sModeratorAccess = trim($sModeratorAccess);
        $sModeratorAccess = array_map('trim', explode(',', $sModeratorAccess));
        ...
        $array = array(
          ...
          's_moderator_access'   =>  $sModeratorAccess
        );
      ...
      case('edit_post'):
        ...
        if($adminId!=osc_logged_admin_id()) {
          ...
          $array['s_moderator_access'] = $sModeratorAccess;
        }
