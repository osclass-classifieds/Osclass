...
class LanguageForm extends Form {
  ...
  */
  public static function def_currency_select($locale = null, $currencies = null) {
    ...
    parent::generic_select('fk_c_currency_code', $currencies, 'pk_c_code', 'pk_c_code', null, $default_key);
  ...
  * @return bool
  */
  public static function locations_native_input_checkbox($locale = null) {
  ...
  * @return bool
  */
  public static function rtl_input_checkbox($locale = null) {
    parent::generic_input_checkbox('b_rtl', '1', $locale['b_rtl'] == 1);
    return true;
  }
